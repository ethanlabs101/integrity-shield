...
---
## ***Integrity Shield is a lightweight file integrity monitoring tool built in Python.*** It scans directories, generates SHA-256 hashes for files/folders, and compares snapshots to detect changes such as modifications, new files, or missing files.
---
